...
#peer chaincode install -n fabInvoice -v 1.1 -l "golang" -p "github.com/fabInvoice/go"
#peer chaincode upgrade -n fabInvoice -v 1.1 -o orderer.example.com:7050 -C mychannel -l "golang" -p "github.com/fabcar/go" -c '{"Args":[""]}' -P "OR ('Org1MSP.member','Org2MSP.member')"

#peer chaincode invoke -o orderer.example.com:7050 -C mychannel -n fabInvoice -c '{"function":"queryAllCars","Args":[""]}'